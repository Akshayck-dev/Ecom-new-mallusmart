...
export default function About() {
  return (
    <main className="pt-24 sm:pt-32 pb-20 bg-white min-h-screen">
      {/* Hero */}
      <section className="px-4 sm:px-6 lg:px-8 max-w-screen-xl mx-auto mb-32">
      ...
      <section className="section-spacing bg-surface-container-low px-4 sm:px-6 lg:px-8 border-y border-primary/5">
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div className="aspect-square bg-white rounded-[3rem] p-12 sm:p-20 flex items-center justify-center shadow-premium border border-primary/5">
            <motion.div 
              animate={{ y: [0, -12, 0] }}
      ...
      <section className="section-spacing px-4 sm:px-6 lg:px-8 max-w-screen-xl mx-auto">
        <div className="text-center mb-16 sm:mb-24">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-tighter mb-6">The Artisan Network</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {[
            ...
            <div key={i} className="bg-white p-10 sm:p-14 rounded-[2rem] sm:rounded-[3rem] text-center shadow-premium border border-primary/5 hover:border-secondary/20 transition-all duration-500 group">
              <div className="text-5xl sm:text-6xl font-bold text-primary mb-4 tracking-tighter group-hover:text-secondary transition-colors">{stat.value}</div>
